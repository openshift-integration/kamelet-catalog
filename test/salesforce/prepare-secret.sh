...
kubectl create secret generic salesforce-binding-credentials --from-file=salesforce-credentials.properties

# bind secret to test by name
kubectl label secret salesforce-credentials yaks.citrusframework.org/test=salesforce-source
kubectl label secret salesforce-binding-credentials yaks.citrusframework.org/test=salesforce-binding
