...
oc create secret generic slack-kafka-binding --from-file=../slack-credentials.properties -n ${YAKS_NAMESPACE}
...
oc label secret slack-kafka-binding yaks.citrusframework.org/test=slack-kafka-binding -n ${YAKS_NAMESPACE}
