...
public class KameletsCatalog {
    ...
    public List<Kamelet> getKameletsByNamespace(String namespace) {
        List<Kamelet> collect = kameletModels.entrySet().stream()
                .peek(x -> LOG.info("getKameletsByNamespace - kamelet: " + x.getKey()))
                .filter(x -> x.getValue().getMetadata().getAnnotations().containsKey(KameletAnnotationsNames.KAMELET_ANNOTATION_NAMESPACE))
    ...
    public List<Kamelet> getKameletsByGroups(String group) {
        List<Kamelet> collect = kameletModels.entrySet().stream()
                .filter(x -> x.getValue().getMetadata().getAnnotations().containsKey(KameletAnnotationsNames.KAMELET_ANNOTATION_GROUP))
    ...
    public List<Kamelet> getKameletByProvider(String provider) {
        List<Kamelet> collect = kameletModels.entrySet().stream()
                .filter(x -> x.getValue().getMetadata().getAnnotations().containsKey(KameletAnnotationsNames.KAMELET_ANNOTATION_PROVIDER))
